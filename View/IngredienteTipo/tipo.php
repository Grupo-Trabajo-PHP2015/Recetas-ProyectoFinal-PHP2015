    ...
    <!-- Menu de navegacion horizontal -->
        ...
        <div class="container">
            ...
            <div class="col-md-7">
                    ...
                    <div class="item active"> <img src="../Assets/img/11.jpg" style="width:100%" data-src="holder.js/900x500/auto/#7cbf00:#fff/text: " alt="First slide">
                        <div class="container">
                ...
                <div class="col-md-5">
                    ...
                    <form class="form-horizontal"  method="POST" action="" >
                        <fieldset>
                            ...
                            <!-- Form Name -->
                            <hr>
                            <h2 style="text-align: left" >Editar tipo de ingrediente</h2>
                            <hr>

                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-1 control-label" for="titulo">Identificacion:</label>  
                                <div class="col-md-6">
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-1 control-label" for="porciones">Tipo:</label>  
                                <div class="col-md-6">
                                    <input id="textinput1" name="nombre" type="text" placeholder="" class="form-control input-md"  value=" <?php echo $clasificacionEdi;  ?>"  >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <button id="editar" name="editar" type="submit" class="btn btn-success" >Modificar tipo ingrediente</button>
                                </div>
                            </div>
                    <br>
